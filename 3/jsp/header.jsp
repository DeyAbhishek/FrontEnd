      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <img src="../img/logo.jpg" height="50" style="float: left; padding-right:20px;">    
            <a class="navbar-brand" style="font-size: 24px; color: black;" href="#">
            Water Quality Collection System</a></img>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            ...
            -->
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="standards.jsp">Standards/Preservatives</a></li>
                </ul>
              </li>
                 <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="active2"><a href="#">Elizabeth Mace</a></li>
              <li class="active2"><a href="../"><button type="button" id="logout" class="btn btn-xs btn-warning" style="border:0; margin:0">Logout</button></a></li>
            </ul>
