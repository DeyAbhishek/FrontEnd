...
<br>
    <div class="panel panel-default"> 
        ...
        <div class="panel-body">
              <div class="row">
                <label class="col-xs-3 control-label" align="right">Temperature:</label>
                <div class="col-xs-1" align="right">
                                    0.5
                </div>
                <label class="col-xs-2 control-label" align="left">deg C</label>
                
                <label class="col-xs-2 control-label" align="right">Temperature 2:</label>
                <div class="col-xs-1" align="right">
                                    1.0
                </div>
                <label class="col-xs-3 control-label" align="left">deg C</label>
            </div><br>
            
            <div class="row">
                <label class="col-xs-3 control-label" align="right">DO:</label>
                <div class="col-xs-1" align="right">
                                    0.3
                </div>
                <label class="col-xs-2 control-label" align="left">mg/L</label>
                
                <label class="col-xs-2 control-label" align="right">pH</label>
                <div class="col-xs-1" align="right">
                                    0.2
                </div>
                <label class="col-xs-3 control-label" align="left">s.u.</label>
            </div><br>
            
             <div class="row">
                <label class="col-xs-3 control-label" align="right">Conductivity:</label>
                <div class="col-xs-1" align="right">
                05
                </div>
                <label class="col-xs-2 control-label" align="left">%</label>
                
                <label class="col-xs-2 control-label" align="right">Depth</label>
                <div class="col-xs-1" align="right">
                                    0.0
                </div>
                <label class="col-xs-3 control-label" align="left">m</label>
            </div><br>
            
             <div class="row">
                <label class="col-xs-3 control-label" align="right">BGA/Chlorophyll</label>
                <div class="col-xs-1" align="right">
                xx
                </div>
                <label class="col-xs-2 control-label" align="left">unit</label>
                
                <label class="col-xs-2 control-label" align="right">fdom</label>
                <div class="col-xs-1" align="right">
                xx
                </div>
                <label class="col-xs-3 control-label" align="left">unit</label>
            </div><br>
            
             <div class="row">
                <label class="col-xs-3 control-label" align="right">Turbidity:</label>
                <div class="col-xs-1" align="right">
                    0.1
                </div>
                <label class="col-xs-2 control-label" align="left">%</label>
