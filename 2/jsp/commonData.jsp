...
<!DOCTYPE html>
<div class="row"><br>
                      <label class="col-xs-2 control-label"  align="right">Station ID:</label>
                      <div class="col-xs-2">Report StationID</div>
                      <label class="col-xs-2 control-label" align="right">Collection Date:</label>
                      <div class="col-xs-2">
                      <input type="date" class="form-control" placeholder="From Date" />
                      </div>
                      <label class="col-xs-2 control-label" align="right">Collection Time:</label> 
                      <div class="col-xs-2">
