<!DOCTYPE html>
    ...
    <label class="col-xs-2 control-label" align="right">Measuring Point Elev:</label>
      <div class="col-xs-2">
       <input type="text" class="form-control" id="measuringPointElevation"  onchange="bigcalculator()"/> 
      </div>
      ...
      <br>
         ...
         <div class="row">    
       <label class="col-xs-2 control-label" align="right">Casing Depth:</label>
        <div class="col-xs-2">
       ...
       <input type="text"  onchange="bigcalculator()" id="stickup" class="form-control"/>
...
<label class="radio-inline"><input type="radio" name="optradio">No</label>
      ...
      <br>
       ...
       <label class="col-xs-2 control-label" align="right">Well Volumes Purged:</label>
        <div id="wellVolumesPurged" class="col-xs-2">
        </div> 
      </div>
...
function bigcalculator(){
    ...
    var wellVolumesPurged=(endTime-beginTime)*purgeRate;
